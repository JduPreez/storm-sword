...
async fn list_events(req: ListEventsRequest) -> Result<ListEventsResponse, Error> {
  ...
  let events = vec![
      Event {
          ...
          ns: Some("TrailRunning/SouthAfrica/WesternCape".to_string()),
      ...
      Event {
          ...
          ns: Some("TrailRunning/SouthAfrica/Gauteng".to_string()),
      ...
      Event {
          ...
          ns: Some("TrailRunning/UnitedKingdom/London".to_string()),
